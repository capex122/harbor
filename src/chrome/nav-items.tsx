...
import { BookOpen, BookText, GalleryVerticalEnd, Popcorn } from "lucide-react";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: "ebook", label: "eBook", render: (active) => <BookText size={24} strokeWidth={2.2} className={active ? "" : "opacity-70"} />, view: "ebook" },
